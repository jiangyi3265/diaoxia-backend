...
-- 首次登录密码: admin123；pwd_update_date 留空，前端将强制进入修改密码流程。
insert into sys_user values(1, 101, 'admin', '管理员', '00', 'admin@qq.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '超级管理员');
...
insert into sys_config values(6, '账号安全-初始密码强制修改',    'sys.account.initPasswordModify', '1',        'Y', 'admin', sysdate(), '', null, '');
